...
module.exports = function (neo4j)
{
	...
	{
		var args = neo4j.Utils.parseArgs(arguments, _indexFormat);
		...
		neo4j.Utils.autoBatch(args.batch, neo4j.Api.getEndpoint(endpoint, args.index), 'POST', data, args.callback);
	};
