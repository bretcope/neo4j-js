...
function Graph (neo4j)
{
	...
	{
		var args = neo4j.Utils.parseArgs(arguments, _cypherArgsFormat);
	...
	{
		var args = neo4j.Utils.parseArgs(arguments, _indexStatusFormat);
	...
	{
		var args = neo4j.Utils.parseArgs(arguments, _indexPropertyFormat);
		var body, endpoint;
	...
	{
		var args = neo4j.Utils.parseArgs(arguments, _indexSetFormat);
	...
	{
		var args = neo4j.Utils.parseArgs(arguments, _createNodeFormat);
