...
module.exports = function (neo4j)
{
	...
	var _getRelsFormat = [ { name: 'batch', optional: true, instance: neo4j.Api.Batch },
						   ...
						   { name: 'types', optional: true, instance: Array },
						   { name: 'callback', type: 'function' } ];
	
	var _updatePropsFormat = [ { name: 'batch', optional: true, instance: neo4j.Api.Batch },
	...
	{
		var args = neo4j.Utils.parseArgs(arguments, _createRelFormat);
	...
	{
		var args = neo4j.Utils.parseArgs(arguments, _getRelsFormat);
